...
assentuse = REQUEST.get('assent_use')
if (not assentuse):
    state.setError('assent_use', _(u'Check the indicated box if you aggree to the following terms.'))
    context.plone_utils.addPortalMessage(_(u'Before registering to the tutor-web please verify if you agree to the indicated terms. Select cancel if you  do not  agree or want to register later.'), 'error')
